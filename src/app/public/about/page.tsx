    ...
    <div className="sm: flex flex-col justify-center gap-y-4 py-6 sm:w-full sm:px-0">
      ...
      {isSmallScreen ? (
        <div className="mt-4 flex flex-col">
          <div className="aspect-w-16 aspect-h-9 flex flex-col pb-12">
            <Image
              src={LivesReflected}
              alt="Their Lives Reflected"
              className="flex aspect-auto object-contain p-6"
              height={300}
            />{" "}
            ...
            <p className="mt-5 h-20 text-center text-sm">
              <span>
                <Link
                  ...
                  className="italic text-[#742B1A] hover:underline"
                >
                  Sundaes & Sundays: A Collection of Life Histories as captured
                  by The Legacy Project at Tufts: Volume 1
                </Link>
              </span>{" "}
              is a collection of twelve life stories of older adults residing in
              a Massachusetts senior living community.
            </p>
          </div>
        </div>
      ) : (
